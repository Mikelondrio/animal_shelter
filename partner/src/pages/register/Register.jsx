    ...
    return (
        <section className="register-login">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input name="user_name" type="text" value={userData.user_name} onChange={handleUserData} />
                {isRegister &&
                    <>
                    <label htmlFor="user_email">Email</label>
                    <input name="user_email" type="email" value={userData.user_email} onChange={handleUserData} />
                    </>
                }
                <label htmlFor="user_password">Password</label>
                <input name="user_password" type="password" value={userData.user_password} onChange={handleUserData} />
                {isRegister &&
                    <>
